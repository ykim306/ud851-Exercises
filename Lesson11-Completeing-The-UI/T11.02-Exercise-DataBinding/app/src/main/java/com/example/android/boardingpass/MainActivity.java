...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        SimpleDateFormat dtFormatter = new SimpleDateFormat(getString(R.string.timeFormat), Locale.getDefault());
        String boardingTime = dtFormatter.format(info.boardingTime);
        String departureTime = dtFormatter.format(info.departureTime);
        String arrivalTime = dtFormatter.format(info.arrivalTime);
