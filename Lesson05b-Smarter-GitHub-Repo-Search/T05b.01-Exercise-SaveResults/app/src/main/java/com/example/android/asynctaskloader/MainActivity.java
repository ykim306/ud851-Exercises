...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_JSON_KEY = "searchJsonKey";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String searchContent = mSearchResultsTextView.getText().toString();
        // COMPLETED (8) Using the key for the raw JSON search results, put the search results into the outState Bundle
        outState.putString(SEARCH_JSON_KEY, searchContent);
    }
}